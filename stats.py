...
def stats(RD,size_factor,rate_factor,rate_cutoff,coverage_cutoff,rate_dep_cutoff,cutoff,conf,show=False):
...
def comp_phase_print(RD,snps_to_use):
                ...
                X = alg.RNA_phase(RD,.0001,global_vars.pair_thresh)
                S =[switches_in_comp2(x,X,global_vars.V,RD)[0] for x in X]
