...
if RNAfragmat == None or gene_data == None:
    ...
    if DNAfragmat == None: #Only RNA data provided without gene info
        ...
        GX = newalg.RNA_phase(.001,pair_thresh,.02,G.read_dict, G.comp_mins, G.components)
    ...
    jGX = newalg.RNA_phase(.001,pair_thresh,.02,jG.read_dict, jG.comp_mins, jG.components)
    time3 = time.time()
    print('Pt 3 took ', time3-time2)
